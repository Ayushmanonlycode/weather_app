 ...
 * Defines different styles for the button component including:
 ...
 * Extends button HTML attributes and adds variant props
 * @property asChild - When true, renders the button as a child component using Radix UI's Slot
 */
